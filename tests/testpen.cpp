...
static void getImage (GpBitmap **image)
{
	GpStatus status;
...
{
	assertTrue (pen) << "Expected the pen to be initalized.";
	...
	assertEqualInt (status, Ok);
	assertFalse (customStartCap);

	status = GdipGetPenCustomEndCap (pen, &customEndCap);
	assertEqualInt (status, Ok);
	assertFalse (customEndCap);
...
static void test_setPenStartCap ()
{
	...
	status = GdipGetPenCustomStartCap (pen, &customStartCap);
	assertEqualInt (status, Ok);
	assertFalse (customStartCap) << "Expected the pen's custom start cap to be cleared.";
...
static void test_setPenEndCap ()
{
	...
	status = GdipGetPenCustomEndCap (pen, &customEndCap);
	assertEqualInt (status, Ok);
	assertFalse (customEndCap) << "Expected the pen's custom end cap to be cleared.";
...
static void test_setPenCustomStartCap ()
{
	...
	status = GdipGetPenCustomStartCap (pen, &customStartCap);
	assertEqualInt (status, Ok);
	assertTrue (customStartCap);
	assertTrue (customStartCap != penCustomLineCap);
...
static void test_setPenCustomEndCap ()
{
	...
	status = GdipGetPenCustomEndCap (pen, &customEndCap);
	assertEqualInt (status, Ok);
	assertTrue (customEndCap);
	assertTrue (customEndCap != penCustomLineCap);
...
static void test_setPenBrushFill ()
{
	...
	assertEqualInt (status, Ok);
	assertTrue (brush);
	assertTrue (brush != solidBrush) << "Expected new brush to be a clone.";
	...
	assertEqualInt (status, Ok);
	assertTrue (brush);
	assertTrue (brush != textureBrush) << "Expected new brush to be a clone.";
...
LIBGDIPLUS_TEST (testpen, test_createPen1)
LIBGDIPLUS_TEST (testpen, test_createPen2)
LIBGDIPLUS_TEST (testpen, test_clone)
LIBGDIPLUS_TEST (testpen, test_getPenWidth)
LIBGDIPLUS_TEST (testpen, test_setPenWidth)
LIBGDIPLUS_TEST (testpen, test_setPenUnit)
LIBGDIPLUS_TEST (testpen, test_getPenUnit)
LIBGDIPLUS_TEST (testpen, test_setPenLineCap197819)
LIBGDIPLUS_TEST (testpen, test_setPenStartCap)
LIBGDIPLUS_TEST (testpen, test_setPenEndCap)
LIBGDIPLUS_TEST (testpen, test_setPenDashCap197819)
LIBGDIPLUS_TEST (testpen, test_getPenStartCap)
LIBGDIPLUS_TEST (testpen, test_getPenEndCap)
LIBGDIPLUS_TEST (testpen, test_getPenDashCap197819)
LIBGDIPLUS_TEST (testpen, test_setPenLineJoin)
LIBGDIPLUS_TEST (testpen, test_getPenLineJoin)
LIBGDIPLUS_TEST (testpen, test_setPenCustomStartCap)
LIBGDIPLUS_TEST (testpen, test_getPenCustomStartCap)
LIBGDIPLUS_TEST (testpen, test_setPenCustomEndCap)
LIBGDIPLUS_TEST (testpen, test_getPenCustomEndCap)
LIBGDIPLUS_TEST (testpen, test_setPenMiterLimit)
LIBGDIPLUS_TEST (testpen, test_getPenMiterLimit)
LIBGDIPLUS_TEST (testpen, test_setPenMode)
LIBGDIPLUS_TEST (testpen, test_getPenMode)
LIBGDIPLUS_TEST (testpen, test_getPenTransform)
LIBGDIPLUS_TEST (testpen, test_setPenTransform)
LIBGDIPLUS_TEST (testpen, test_multiplyPenTransform)
LIBGDIPLUS_TEST (testpen, test_translatePenTransform)
LIBGDIPLUS_TEST (testpen, test_scalePenTransform)
LIBGDIPLUS_TEST (testpen, test_rotatePenTransform)
LIBGDIPLUS_TEST (testpen, test_setPenColor)
LIBGDIPLUS_TEST (testpen, test_getPenColor)
LIBGDIPLUS_TEST (testpen, test_getPenFillType)
LIBGDIPLUS_TEST (testpen, test_setPenBrushFill)
LIBGDIPLUS_TEST (testpen, test_getPenBrushFill)
LIBGDIPLUS_TEST (testpen, test_getPenDashStyle)
LIBGDIPLUS_TEST (testpen, test_setPenDashStyle)
LIBGDIPLUS_TEST (testpen, test_getPenDashOffset)
LIBGDIPLUS_TEST (testpen, test_setPenDashOffset)
LIBGDIPLUS_TEST (testpen, test_getPenDashCount)
LIBGDIPLUS_TEST (testpen, test_setPenDashArray)
LIBGDIPLUS_TEST (testpen, test_getPenDashArray)
LIBGDIPLUS_TEST (testpen, test_getPenCompoundCount)
LIBGDIPLUS_TEST (testpen, test_setPenCompoundArray)
LIBGDIPLUS_TEST (testpen, test_getPenCompoundArray)
LIBGDIPLUS_TEST (testpen, test_deletePen)
