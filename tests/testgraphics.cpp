...
LIBGDIPLUS_TEST (testgraphics, test_createFromHDC)
LIBGDIPLUS_TEST (testgraphics, test_createFromHDC2)
LIBGDIPLUS_TEST (testgraphics, test_createFromHWND)
LIBGDIPLUS_TEST (testgraphics, test_createFromHWNDICM)
LIBGDIPLUS_TEST (testgraphics, test_hdc)
LIBGDIPLUS_TEST (testgraphics, test_compositingMode)
LIBGDIPLUS_TEST (testgraphics, test_compositingQuality)
LIBGDIPLUS_TEST (testgraphics, test_renderingOrigin)
LIBGDIPLUS_TEST (testgraphics, test_textRenderingHint)
LIBGDIPLUS_TEST (testgraphics, test_textContrast)
LIBGDIPLUS_TEST (testgraphics, test_smoothingMode)
LIBGDIPLUS_TEST (testgraphics, test_pixelOffsetMode)
LIBGDIPLUS_TEST (testgraphics, test_interpolationMode)
LIBGDIPLUS_TEST (testgraphics, test_transform)
LIBGDIPLUS_TEST (testgraphics, test_pageUnit)
LIBGDIPLUS_TEST (testgraphics, test_pageScale)
LIBGDIPLUS_TEST (testgraphics, test_dpiX)
LIBGDIPLUS_TEST (testgraphics, test_dpiY)
LIBGDIPLUS_TEST (testgraphics, test_flush)
LIBGDIPLUS_TEST (testgraphics, test_delete)
LIBGDIPLUS_TEST (testgraphics, test_rotateWorldTransform)
LIBGDIPLUS_TEST (testgraphics, test_resetClip)
LIBGDIPLUS_TEST (testgraphics, test_getClip)
LIBGDIPLUS_TEST (testgraphics, test_getClipBounds)
LIBGDIPLUS_TEST (testgraphics, test_getClipBoundsI)
LIBGDIPLUS_TEST (testgraphics, test_getVisibleClipBounds)
LIBGDIPLUS_TEST (testgraphics, test_getVisibleClipBoundsI)
LIBGDIPLUS_TEST (testgraphics, test_isClipEmpty)
LIBGDIPLUS_TEST (testgraphics, test_isVisibleClipEmpty)
LIBGDIPLUS_TEST (testgraphics, test_setClipGraphics)
LIBGDIPLUS_TEST (testgraphics, test_setClipHrgn)
LIBGDIPLUS_TEST (testgraphics, test_setClipRect)
LIBGDIPLUS_TEST (testgraphics, test_setClipRectI)
LIBGDIPLUS_TEST (testgraphics, test_setClipRegion)
LIBGDIPLUS_TEST (testgraphics, test_setClipPath)
LIBGDIPLUS_TEST (testgraphics, test_translateClip)
LIBGDIPLUS_TEST (testgraphics, test_translateClipI)
LIBGDIPLUS_TEST (testgraphics, test_region_mask)
LIBGDIPLUS_TEST (testgraphics, test_premultiplication)
LIBGDIPLUS_TEST (testgraphics, test_world_transform_in_container)
LIBGDIPLUS_TEST (testgraphics, test_world_transform_respects_page_unit_document)
LIBGDIPLUS_TEST (testgraphics, test_world_transform_respects_page_unit_point)
LIBGDIPLUS_TEST (testgraphics, test_saveGraphics)
LIBGDIPLUS_TEST (testgraphics, test_restoreGraphics)
