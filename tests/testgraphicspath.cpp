...
LIBGDIPLUS_TEST (testgraphicspath, test_createPath)
LIBGDIPLUS_TEST (testgraphicspath, test_createPath2)
LIBGDIPLUS_TEST (testgraphicspath, test_createPath2I)
LIBGDIPLUS_TEST (testgraphicspath, test_clonePath)
LIBGDIPLUS_TEST (testgraphicspath, test_deletePath)
LIBGDIPLUS_TEST (testgraphicspath, test_resetPath)
LIBGDIPLUS_TEST (testgraphicspath, test_getPointCount)
LIBGDIPLUS_TEST (testgraphicspath, test_getPathTypes)
LIBGDIPLUS_TEST (testgraphicspath, test_getPathPoints)
LIBGDIPLUS_TEST (testgraphicspath, test_getPathPointsI)
LIBGDIPLUS_TEST (testgraphicspath, test_getPathData)
LIBGDIPLUS_TEST (testgraphicspath, test_getPathFillMode)
LIBGDIPLUS_TEST (testgraphicspath, test_setPathFillMode)
LIBGDIPLUS_TEST (testgraphicspath, test_startPathFigure)
LIBGDIPLUS_TEST (testgraphicspath, test_closePathFigure)
LIBGDIPLUS_TEST (testgraphicspath, test_closePathFigures)
LIBGDIPLUS_TEST (testgraphicspath, test_setPathMarker)
LIBGDIPLUS_TEST (testgraphicspath, test_clearPathMarkers)
LIBGDIPLUS_TEST (testgraphicspath, test_reversePath)
LIBGDIPLUS_TEST (testgraphicspath, test_getPathLastPoint)
LIBGDIPLUS_TEST (testgraphicspath, test_flattenPath)
LIBGDIPLUS_TEST (testgraphicspath, test_windingModeOutline)
LIBGDIPLUS_TEST (testgraphicspath, test_transformPath)
LIBGDIPLUS_TEST (testgraphicspath, test_addPathArc)
LIBGDIPLUS_TEST (testgraphicspath, test_addPathArcI)
LIBGDIPLUS_TEST (testgraphicspath, test_addPathPie)
LIBGDIPLUS_TEST (testgraphicspath, test_addPathPieI)
LIBGDIPLUS_TEST (testgraphicspath, test_addPathString)
LIBGDIPLUS_TEST (testgraphicspath, test_addPathStringI)
