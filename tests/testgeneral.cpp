...
static void test_startup ()
{
	...
	assertEqualInt (status, Ok);
	assertTrue (gdiplusToken);
	assertTrue (!gdiplusStartupOutput.NotificationHook && !gdiplusStartupOutput.NotificationUnhook);
	GdiplusShutdown (gdiplusToken);
...
LIBGDIPLUS_TEST_WITHOUT_INIT (testgeneral, test_startup)
LIBGDIPLUS_TEST_WITHOUT_INIT (testgeneral, test_shutdown)
LIBGDIPLUS_TEST_WITHOUT_INIT (testgeneral, test_notificationHook)
LIBGDIPLUS_TEST_WITHOUT_INIT (testgeneral, test_notificationUnhook)
LIBGDIPLUS_TEST_WITHOUT_INIT (testgeneral, test_alloc)
LIBGDIPLUS_TEST_WITHOUT_INIT (testgeneral, test_free)
LIBGDIPLUS_TEST_WITHOUT_INIT (testgeneral, test_notInitialized)
