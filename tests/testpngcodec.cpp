...
{ \
	...
	fclose (f); \
 \
	status = GdipLoadImageFromFile (wFile, &testpngcodec_image); \
...
{ \
	...
	verifyBitmap (testpngcodec_image, pngRawFormat, format, width, height, flags, propertyCount, FALSE); \
	GdipDisposeImage (testpngcodec_image); \
}
...
LIBGDIPLUS_TEST (testpngcodec, test_valid1bpp)
LIBGDIPLUS_TEST (testpngcodec, test_valid2bpp)
LIBGDIPLUS_TEST (testpngcodec, test_valid4bpp)
LIBGDIPLUS_TEST (testpngcodec, test_valid8bpp)
LIBGDIPLUS_TEST (testpngcodec, test_valid16bpp)
LIBGDIPLUS_TEST (testpngcodec, test_valid)
LIBGDIPLUS_TEST (testpngcodec, test_invalidHeader)
LIBGDIPLUS_TEST (testpngcodec, test_invalidHeaderChunk)
LIBGDIPLUS_TEST (testpngcodec, test_invalidImageData)
LIBGDIPLUS_TEST (testpngcodec, test_invalidImageFormat)
