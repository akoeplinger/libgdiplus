...
static void test_createPathGradient ()
{
    ...
    assertEqual (brush, (GpPathGradient *) 0xCC);
...
static void test_setPathGradientGammaCorrection ()
{
    ...
    GdipGetPathGradientGammaCorrection (brush, &useGammaCorrection);
    assertFalse (useGammaCorrection);
...
static void test_setPathGradientTransform ()
{
    ...
    assertTrue (transform != matrix) << "Expected new matrix to be a clone.";
...
static void test_cloneWithPoints ()
{
    ...
    assertEqualInt (status, Ok);
    assertTrue (clonedBrush);
    assertTrue (clonedBrush != brush);
...
LIBGDIPLUS_TEST (testpathgradientbrush, test_createPathGradient)
LIBGDIPLUS_TEST (testpathgradientbrush, test_createPathGradientI)
LIBGDIPLUS_TEST (testpathgradientbrush, test_createPathGradientFromPath)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientCenterColor)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientCenterColor)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientSurroundColorCount)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientSurroundColorsWithCount)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientSurroundColorsWithCount)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientTransform)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientPath)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientPath)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientCenterPoint)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientCenterPointI)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientCenterPoint)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientCenterPointI)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientRect)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientRectI)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientPointCount)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientGammaCorrection)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientGammaCorrection)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientBlendCount)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientBlend)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientBlend)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientPresetBlendCount)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientPresetBlend)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientPresetBlend)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientSigmaBlend)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientLinearBlend)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientWrapMode)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientWrapMode)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientTransform)
LIBGDIPLUS_TEST (testpathgradientbrush, test_resetPathGradientTransform)
LIBGDIPLUS_TEST (testpathgradientbrush, test_multiplyPathGradientTransform)
LIBGDIPLUS_TEST (testpathgradientbrush, test_translatePathGradientTransform)
LIBGDIPLUS_TEST (testpathgradientbrush, test_scalePathGradientTransform)
LIBGDIPLUS_TEST (testpathgradientbrush, test_rotatePathGradientTransform)
LIBGDIPLUS_TEST (testpathgradientbrush, test_getPathGradientFocusScales)
LIBGDIPLUS_TEST (testpathgradientbrush, test_setPathGradientFocusScales)
LIBGDIPLUS_TEST (testpathgradientbrush, test_cloneWithPoints)
LIBGDIPLUS_TEST (testpathgradientbrush, test_cloneWithPath)
LIBGDIPLUS_TEST (testpathgradientbrush, test_delete)
