...
static void test_createCustomLineCap ()
{
	...
	assertEqual (cap, (GpCustomLineCap *) 0xCC);
...
LIBGDIPLUS_TEST (testcustomlinecap, test_createCustomLineCap)
LIBGDIPLUS_TEST (testcustomlinecap, test_deleteCustomLineCap)
LIBGDIPLUS_TEST (testcustomlinecap, test_cloneCustomLineCap)
LIBGDIPLUS_TEST (testcustomlinecap, test_getCustomLineCapType)
LIBGDIPLUS_TEST (testcustomlinecap, test_setCustomLineCapStrokeCaps)
LIBGDIPLUS_TEST (testcustomlinecap, test_getCustomLineCapStrokeCaps)
LIBGDIPLUS_TEST (testcustomlinecap, test_setCustomLineCapStrokeJoin)
LIBGDIPLUS_TEST (testcustomlinecap, test_getCustomLineCapStrokeJoin)
LIBGDIPLUS_TEST (testcustomlinecap, test_setCustomLineCapBaseCap)
LIBGDIPLUS_TEST (testcustomlinecap, test_getCustomLineCapBaseCap)
LIBGDIPLUS_TEST (testcustomlinecap, test_setCustomLineCapBaseInset)
LIBGDIPLUS_TEST (testcustomlinecap, test_getCustomLineCapBaseInset)
LIBGDIPLUS_TEST (testcustomlinecap, test_setCustomLineCapWidthScale)
LIBGDIPLUS_TEST (testcustomlinecap, test_getCustomLineCapWidthScale)
