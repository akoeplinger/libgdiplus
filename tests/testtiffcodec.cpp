...
{ \
	...
	fclose (f); \
 \
	status = GdipLoadImageFromFile (wFile, &testtiffcodec_image); \
...
{ \
	...
	verifyBitmap (testtiffcodec_image, tifRawFormat, PixelFormat24bppRGB, width, height, flags, propertyCount, TRUE); \
	GdipDisposeImage (testtiffcodec_image); \
}
...
LIBGDIPLUS_TEST (testtiffcodec, test_valid)
LIBGDIPLUS_TEST (testtiffcodec, test_units)
LIBGDIPLUS_TEST (testtiffcodec, test_validGdiplus)
LIBGDIPLUS_TEST (testtiffcodec, test_invalidHeader)
LIBGDIPLUS_TEST (testtiffcodec, test_invalidFileDirectory)
LIBGDIPLUS_TEST (testtiffcodec, test_invalidTag)
LIBGDIPLUS_TEST (testtiffcodec, test_missingTag)
LIBGDIPLUS_TEST (testtiffcodec, test_invalidSpecificTag)
