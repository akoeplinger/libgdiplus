...
static void test_createLineBrush ()
{
    ...
    assertEqual (brush, (GpLineGradient *) 0xCC);
...
LIBGDIPLUS_TEST (testlineargradientbrush, test_createLineBrush)
LIBGDIPLUS_TEST (testlineargradientbrush, test_createLineBrushI)
LIBGDIPLUS_TEST (testlineargradientbrush, test_createLineBrushFromRect)
LIBGDIPLUS_TEST (testlineargradientbrush, test_createLineBrushFromRectI)
LIBGDIPLUS_TEST (testlineargradientbrush, test_createLineBrushFromRectWithAngle)
LIBGDIPLUS_TEST (testlineargradientbrush, test_createLineBrushFromRectWithAngleI)
LIBGDIPLUS_TEST (testlineargradientbrush, test_setLineColors)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLineColors)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLineRect)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLineRectI)
LIBGDIPLUS_TEST (testlineargradientbrush, test_setLineGammaCorrection)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLineGammaCorrection)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLineBlendCount)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLineBlend)
LIBGDIPLUS_TEST (testlineargradientbrush, test_setLineBlend)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLinePresetBlendCount)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLinePresetBlend)
LIBGDIPLUS_TEST (testlineargradientbrush, test_setLinePresetBlend)
LIBGDIPLUS_TEST (testlineargradientbrush, test_setLineSigmaBlend)
LIBGDIPLUS_TEST (testlineargradientbrush, test_setLineLinearBlend)
LIBGDIPLUS_TEST (testlineargradientbrush, test_setLineWrapMode)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLineWrapMode)
LIBGDIPLUS_TEST (testlineargradientbrush, test_getLineTransform)
LIBGDIPLUS_TEST (testlineargradientbrush, test_setLineTransform)
LIBGDIPLUS_TEST (testlineargradientbrush, test_resetLineTransform)
LIBGDIPLUS_TEST (testlineargradientbrush, test_multiplyLineTransform)
LIBGDIPLUS_TEST (testlineargradientbrush, test_translateLineTransform)
LIBGDIPLUS_TEST (testlineargradientbrush, test_scaleLineTransform)
LIBGDIPLUS_TEST (testlineargradientbrush, test_rotateLineTransform)
LIBGDIPLUS_TEST (testlineargradientbrush, test_clone)
LIBGDIPLUS_TEST (testlineargradientbrush, test_delete)
