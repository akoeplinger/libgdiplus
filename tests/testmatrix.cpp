...
static void test_createMatrix3 ()
{
	...
	assertEqualInt (status, InvalidParameter);
	assertEqual (matrix, (GpMatrix *) 0xCC);
...
static void test_cloneMatrix ()
{
	...
	assertEqualInt (status, Ok);
	assertTrue (clonedMatrix);
	assertTrue (clonedMatrix != matrix);
	...
	assertEqualInt (status, InvalidParameter);
	assertEqual (clonedMatrix, (GpMatrix *) 0xCC);
...
LIBGDIPLUS_TEST (testmatrix, test_createMatrix)
LIBGDIPLUS_TEST (testmatrix, test_createMatrix2)
LIBGDIPLUS_TEST (testmatrix, test_createMatrix3)
LIBGDIPLUS_TEST (testmatrix, test_createMatrix3I)
LIBGDIPLUS_TEST (testmatrix, test_cloneMatrix)
LIBGDIPLUS_TEST (testmatrix, test_deleteMatrix)
LIBGDIPLUS_TEST (testmatrix, test_setMatrixElements)
LIBGDIPLUS_TEST (testmatrix, test_multiplyMatrix)
LIBGDIPLUS_TEST (testmatrix, test_translateMatrix)
LIBGDIPLUS_TEST (testmatrix, test_scaleMatrix)
LIBGDIPLUS_TEST (testmatrix, test_rotateMatrix)
LIBGDIPLUS_TEST (testmatrix, test_shearMatrix)
LIBGDIPLUS_TEST (testmatrix, test_invertMatrix)
LIBGDIPLUS_TEST (testmatrix, test_transformMatrixPoints)
LIBGDIPLUS_TEST (testmatrix, test_transformMatrixPointsI)
LIBGDIPLUS_TEST (testmatrix, test_vectorTransformMatrixPoints)
LIBGDIPLUS_TEST (testmatrix, test_vectorTransformMatrixPointsI)
LIBGDIPLUS_TEST (testmatrix, test_getMatrixElements)
LIBGDIPLUS_TEST (testmatrix, test_isMatrixInvertible)
LIBGDIPLUS_TEST (testmatrix, test_isMatrixIdentity)
LIBGDIPLUS_TEST (testmatrix, test_isMatrixEqual)
