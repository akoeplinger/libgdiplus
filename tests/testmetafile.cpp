...
static void test_getMetafileHeaderFromWmf ()
{
    ...
    // FIXME: these values constantly fluctuate with libgdiplus - potential UB?
#if defined(USE_WINDOWS_GDIPLUS)
    assertTrue (header.DpiX > 0);
    assertTrue (header.DpiY > 0);
    assertEqualInt (header.X, 0);
    assertEqualInt (header.Y, 0);
    assertEqualInt (header.Width, 0);
    assertEqualInt (header.Height, 0);
...
LIBGDIPLUS_TEST (testmetafile, test_createMetafileFromFile)
LIBGDIPLUS_TEST (testmetafile, test_createMetafileFromStream)
LIBGDIPLUS_TEST (testmetafile, test_createMetafileFromEmf)
LIBGDIPLUS_TEST (testmetafile, test_createMetafileFromWmf)
LIBGDIPLUS_TEST (testmetafile, test_getMetafileHeaderFromWmf)
LIBGDIPLUS_TEST (testmetafile, test_getMetafileHeaderFromEmf)
LIBGDIPLUS_TEST (testmetafile, test_getMetafileHeaderFromFile)
LIBGDIPLUS_TEST (testmetafile, test_getMetafileHeaderFromStream)
LIBGDIPLUS_TEST (testmetafile, test_getMetafileHeaderFromMetafile)
LIBGDIPLUS_TEST (testmetafile, test_gettHemfFromMetafile)
LIBGDIPLUS_TEST (testmetafile, test_getMetafileDownLevelRasterizationLimit)
LIBGDIPLUS_TEST (testmetafile, test_setMetafileDownLevelRasterizationLimit)
LIBGDIPLUS_TEST (testmetafile, test_playMetafileRecord)
LIBGDIPLUS_TEST (testmetafile, test_recordMetafile)
