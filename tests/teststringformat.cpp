...
static void verifyStringFormat (GpStringFormat *format, INT expectedAttributes, StringTrimming expectedTrimming)
{
	...
	assertEqualInt (digitSubstitution, StringDigitSubstituteUser);
...
LIBGDIPLUS_TEST (teststringformat, test_createStringFormat)
LIBGDIPLUS_TEST (teststringformat, test_getGenericDefault)
LIBGDIPLUS_TEST (teststringformat, test_getGenericTypographic)
LIBGDIPLUS_TEST (teststringformat, test_deleteStringFormat)
LIBGDIPLUS_TEST (teststringformat, test_cloneStringFormat)
LIBGDIPLUS_TEST (teststringformat, test_setStringFormatAlign)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatAlign)
LIBGDIPLUS_TEST (teststringformat, test_setStringFormatLineAlign)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatLineAlign)
LIBGDIPLUS_TEST (teststringformat, test_setStringFormatTrimming)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatTrimming)
LIBGDIPLUS_TEST (teststringformat, test_setStringFormatHotkeyPrefix)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatHotkeyPrefix)
LIBGDIPLUS_TEST (teststringformat, test_setStringFormatTabStops)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatTabStops)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatTabStopCount)
LIBGDIPLUS_TEST (teststringformat, test_setStringFormatDigitSubstitution)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatDigitSubstitution)
LIBGDIPLUS_TEST (teststringformat, test_setStringFormatFlags)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatFlags)
LIBGDIPLUS_TEST (teststringformat, test_getStringFormatMeasurableCharacterRangeCount)
LIBGDIPLUS_TEST (teststringformat, test_setStringFormatMeasurableCharacterRanges)
