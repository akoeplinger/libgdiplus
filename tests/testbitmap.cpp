...
LIBGDIPLUS_TEST (testbitmap, test_createBitmapFromStream)
LIBGDIPLUS_TEST (testbitmap, test_createBitmapFromFile)
LIBGDIPLUS_TEST (testbitmap, test_createBitmapFromStreamICM)
LIBGDIPLUS_TEST (testbitmap, test_createBitmapFromFileICM)
LIBGDIPLUS_TEST (testbitmap, test_createBitmapFromScan0)
LIBGDIPLUS_TEST (testbitmap, test_createBitmapFromGraphics)
LIBGDIPLUS_TEST (testbitmap, test_bitmapSetPixel)
LIBGDIPLUS_TEST (testbitmap, test_bitmapGetPixel)
LIBGDIPLUS_TEST (testbitmap, test_bitmapLockBits)
LIBGDIPLUS_TEST (testbitmap, test_bitmapUnlockBits)
