...
{ \
	...
	fclose (f); \
 \
	status = GdipLoadImageFromFile (wFile, &testwmfcodec_image); \
...
{ \
	...
	verifyMetafile (testwmfcodec_image, wmfRawFormat, x, y, width, height, dimensionWidth, dimensionHeight) \
	GdipDisposeImage (testwmfcodec_image); \
}
...
static void test_invalidDataCorruptingGdiPlus ()
{
	...
	verifyImage (testwmfcodec_image, ImageTypeMetafile, emfRawFormat, PixelFormat32bppRGB, 0, 0, 2, 2, -0.005236f, -0.004651f, -0.104166f, -0.092590f, 327683, 0, TRUE);
	GdipDisposeImage(testwmfcodec_image);
...
LIBGDIPLUS_TEST (testwmfcodec, test_valid)
LIBGDIPLUS_TEST (testwmfcodec, test_invalidDataCorruptingGdiPlus)
LIBGDIPLUS_TEST (testwmfcodec, test_invalidFileSize)
LIBGDIPLUS_TEST (testwmfcodec, test_invalidPlaceableHeader)
LIBGDIPLUS_TEST (testwmfcodec, test_invalidMetafileHeader)
LIBGDIPLUS_TEST (testwmfcodec, test_invalidImageData)
