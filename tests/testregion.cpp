...
static void test_getRegionScans ()
{
	...
	GpRegion *region;
	GpMatrix *matrix;
	GpMatrix *translateMatrix;
	GpMatrix *scaleMatrix;
	GpMatrix *translateScaleMatrix;
	GpMatrix *complexMatrix;
	GpRectF scans[200];
	INT count;

	GdipCreateMatrix (&matrix);
	GdipCreateMatrix (&translateMatrix);
	GdipTranslateMatrix (translateMatrix, 10, 11, MatrixOrderPrepend);
	GdipCreateMatrix (&scaleMatrix);
	GdipScaleMatrix (scaleMatrix, 5, 6, MatrixOrderPrepend);
	GdipCreateMatrix (&translateScaleMatrix);
	GdipTranslateMatrix (translateScaleMatrix, 10, 11, MatrixOrderPrepend);
	GdipScaleMatrix (translateScaleMatrix, 5, 6, MatrixOrderPrepend);
	GdipCreateMatrix2 (1, 2, 3, 4, 5, 6, &complexMatrix);
	...
	assertEqualFloat (scans[0].Y, 20);
	assertEqualFloat (scans[0].Width, 30);
	assertEqualFloat (scans[0].Height, 1);
	assertEqualFloat (scans[1].X, 10);
	assertEqualFloat (scans[1].Y, 21);
	assertEqualFloat (scans[1].Width, 31);
	...
	GdipDeleteMatrix (matrix);
	GdipDeleteMatrix (translateMatrix);
	GdipDeleteMatrix (scaleMatrix);
	GdipDeleteMatrix (translateScaleMatrix);
	GdipDeleteMatrix (complexMatrix);
	GdipDeleteRegion (region);
}
...
LIBGDIPLUS_TEST (testregion, test_createRegion)
LIBGDIPLUS_TEST (testregion, test_createRegionRect)
LIBGDIPLUS_TEST (testregion, test_createRegionRectI)
LIBGDIPLUS_TEST (testregion, test_createRegionPath)
LIBGDIPLUS_TEST (testregion, test_createRegionRgnData)
LIBGDIPLUS_TEST (testregion, test_getRegionData)
LIBGDIPLUS_TEST (testregion, test_getRegionDataReplace)
LIBGDIPLUS_TEST (testregion, test_getRegionDataUnion)
LIBGDIPLUS_TEST (testregion, test_getRegionDataComplement)
LIBGDIPLUS_TEST (testregion, test_getRegionDataSize)
LIBGDIPLUS_TEST (testregion, test_cloneRegion)
LIBGDIPLUS_TEST (testregion, test_deleteRegion)
LIBGDIPLUS_TEST (testregion, test_setInfinite)
LIBGDIPLUS_TEST (testregion, test_setEmpty)
LIBGDIPLUS_TEST (testregion, test_getRegionBounds)
LIBGDIPLUS_TEST (testregion, test_isEmptyRegion)
LIBGDIPLUS_TEST (testregion, test_isEqualRegion)
LIBGDIPLUS_TEST (testregion, test_isInfiniteRegion)
LIBGDIPLUS_TEST (testregion, test_isVisibleRegionPoint)
LIBGDIPLUS_TEST (testregion, test_isVisibleRegionPointI)
LIBGDIPLUS_TEST (testregion, test_isVisibleRegionRect)
LIBGDIPLUS_TEST (testregion, test_isVisibleRegionRectI)
LIBGDIPLUS_TEST (testregion, test_getRegionScansCount)
LIBGDIPLUS_TEST (testregion, test_getRegionScans)
LIBGDIPLUS_TEST (testregion, test_getRegionScansI)
LIBGDIPLUS_TEST (testregion, test_combineReplace)
LIBGDIPLUS_TEST (testregion, test_combineIntersect)
LIBGDIPLUS_TEST (testregion, test_combineUnion)
LIBGDIPLUS_TEST (testregion, test_combineXor)
LIBGDIPLUS_TEST (testregion, test_combineExclude)
LIBGDIPLUS_TEST (testregion, test_combineComplement)
LIBGDIPLUS_TEST (testregion, test_translateRegion)
LIBGDIPLUS_TEST (testregion, test_translateRegionI)
LIBGDIPLUS_TEST (testregion, test_transformRegion)
