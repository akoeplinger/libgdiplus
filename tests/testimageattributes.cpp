...
static void test_createImageAttributes ()
{
	...
	assertTrue (attributes) << "Expected attributes to be initialized.";
...
static void test_cloneImageAttributes ()
{
	...
	assertTrue (attributes != clonedAttributes);
	...
	assertEqualInt (status, InvalidParameter);
	assertEqual (clonedAttributes, (GpImageAttributes *) 0xCC);
...
LIBGDIPLUS_TEST (testimageattributes, test_createImageAttributes)
LIBGDIPLUS_TEST (testimageattributes, test_cloneImageAttributes)
LIBGDIPLUS_TEST (testimageattributes, test_disposeImageAttributes)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesToIdentity)
LIBGDIPLUS_TEST (testimageattributes, test_resetImageAttributes)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesColorMatrix)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesThreshold)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesGamma)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesNop)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesColorKeys)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesOutputChannel)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesOutputChannelColorProfile)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesRemapTable)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesWrapMode)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesICMMode)
LIBGDIPLUS_TEST (testimageattributes, test_getImageAttributesAdjustedPalette)
LIBGDIPLUS_TEST (testimageattributes, test_setImageAttributesCachedBackground)
