...
{ \
    ...
    assertEqual (codec.DllName, nullptr); \
...
LIBGDIPLUS_TEST (testcodecs, test_getImageDecodersSize)
LIBGDIPLUS_TEST (testcodecs, test_getImageDecoders)
LIBGDIPLUS_TEST (testcodecs, test_getImageEncodersSize)
LIBGDIPLUS_TEST (testcodecs, test_getImageEncoders)
