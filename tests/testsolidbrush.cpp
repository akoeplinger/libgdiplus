...
static void test_clone ()
{
    ...
    assertEqualInt (status, Ok);
    assertEqual (solidColor, 0x010203040);
...
static void test_fill ()
{
    ...
    assertEqualInt (status, Ok);
#if defined(USE_WINDOWS_GDIPLUS)
    assertEqual (color, 0xDDA0303F);
#else
    assertEqual (color, 0xDDA02F3F);
#endif
    ...
    assertEqualInt (status, Ok);
#if defined(USE_WINDOWS_GDIPLUS)
    assertEqual (color, 0xFF8B2A37);
#else
    assertEqual (color, 0xFF8B2937);
#endif
...
LIBGDIPLUS_TEST (testsolidbrush, test_clone)
LIBGDIPLUS_TEST (testsolidbrush, test_delete)
LIBGDIPLUS_TEST (testsolidbrush, test_createSolidFill)
LIBGDIPLUS_TEST (testsolidbrush, test_getSolidFillColor)
LIBGDIPLUS_TEST (testsolidbrush, test_setSolidFillColor)
LIBGDIPLUS_TEST (testsolidbrush, test_fill)
