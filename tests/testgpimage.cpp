...
static void test_cloneImage ()
{
	...
	assertTrue (clonedImage && clonedImage != bitmapImage);
	...
	assertEqualInt (status, Ok);
	assertTrue (clonedImage && clonedImage != jpgImage);
	...
	assertEqualInt (status, Ok);
	assertTrue (clonedImage && clonedImage != metafileImage);
...
static void test_getEncoderParameterList ()
{
	...
	assertTrue (memcmp ((void *) &parameters->Parameter[0].Guid, (void *) &compression, sizeof (GUID)) == 0);
	...
	assertTrue (memcmp ((void *) &parameters->Parameter[1].Guid, (void *) &colorDepth, sizeof (GUID)) == 0);
	...
	assertTrue (memcmp ((void *) &parameters->Parameter[2].Guid, (void *) &saveFlag, sizeof (GUID)) == 0);
	...
	assertTrue (memcmp ((void *) &parameters->Parameter[3].Guid, (void *) &saveAsCMYK, sizeof (GUID)) == 0);
	...
	assertTrue (memcmp ((void *) &parameters->Parameter[0].Guid, (void *) &imageItems, sizeof (GUID)) == 0);
	...
	assertTrue (!parameters->Parameter[0].Value);

	assertTrue (memcmp ((void *) &parameters->Parameter[1].Guid, (void *) &saveFlag, sizeof (GUID)) == 0);
	...
	assertTrue (memcmp ((void *) &parameters->Parameter[0].Guid, (void *) &transformation, sizeof (GUID)) == 0);
	assertEqualInt (parameters->Parameter[0].NumberOfValues, 5);
	assertEqualInt (parameters->Parameter[0].Type, EncoderParameterValueTypeLong);
	...
	assertTrue (memcmp ((void *) &parameters->Parameter[1].Guid, (void *) &quality, sizeof (GUID)) == 0);
	assertEqualInt (parameters->Parameter[1].NumberOfValues, 1);
	...
	assertTrue (memcmp ((void *) &parameters->Parameter[2].Guid, (void *) &luminanceTable, sizeof (GUID)) == 0);
	...
	assertTrue (!parameters->Parameter[2].Value);

	assertTrue (memcmp ((void *) &parameters->Parameter[3].Guid, (void *) &chrominanceTable, sizeof (GUID)) == 0);
	...
	assertTrue (!parameters->Parameter[3].Value);

	assertTrue (memcmp ((void *) &parameters->Parameter[4].Guid, (void *) &imageItems, sizeof (GUID)) == 0);
	...
	assertTrue (!parameters->Parameter[4].Value);
...
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromStream)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFile)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromStreamICM)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFileICM)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFileTif)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFileGif)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFilePng)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFileJpg)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFileIcon)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFileWmf)
LIBGDIPLUS_TEST (testgpimage, test_loadImageFromFileEmf)
LIBGDIPLUS_TEST (testgpimage, test_cloneImage)
LIBGDIPLUS_TEST (testgpimage, test_disposeImage)
LIBGDIPLUS_TEST (testgpimage, test_getImageGraphicsContext)
LIBGDIPLUS_TEST (testgpimage, test_getImageBounds)
LIBGDIPLUS_TEST (testgpimage, test_getImageDimension)
LIBGDIPLUS_TEST (testgpimage, test_getImageType)
LIBGDIPLUS_TEST (testgpimage, test_getImageWidth)
LIBGDIPLUS_TEST (testgpimage, test_getImageHeight)
LIBGDIPLUS_TEST (testgpimage, test_getImageHorizontalResolution)
LIBGDIPLUS_TEST (testgpimage, test_getImageVerticalResolution)
LIBGDIPLUS_TEST (testgpimage, test_getImageFlags)
LIBGDIPLUS_TEST (testgpimage, test_getImageRawFormat)
LIBGDIPLUS_TEST (testgpimage, test_getImagePixelFormat)
LIBGDIPLUS_TEST (testgpimage, test_getImageThumbnail)
LIBGDIPLUS_TEST (testgpimage, test_getEncoderParameterListSize)
LIBGDIPLUS_TEST (testgpimage, test_getEncoderParameterList)
LIBGDIPLUS_TEST (testgpimage, test_getFrameDimensionsCount)
LIBGDIPLUS_TEST (testgpimage, test_getFrameDimensionsList)
LIBGDIPLUS_TEST (testgpimage, test_getFrameCount)
LIBGDIPLUS_TEST (testgpimage, test_selectActiveFrame)
LIBGDIPLUS_TEST (testgpimage, test_forceValidation)
LIBGDIPLUS_TEST (testgpimage, test_rotateFlip)
LIBGDIPLUS_TEST (testgpimage, test_getImagePalette)
LIBGDIPLUS_TEST (testgpimage, test_setImagePalette)
LIBGDIPLUS_TEST (testgpimage, test_getImagePaletteSize)
LIBGDIPLUS_TEST (testgpimage, test_getPropertyCount)
LIBGDIPLUS_TEST (testgpimage, test_getPropertyIdList)
LIBGDIPLUS_TEST (testgpimage, test_getPropertyItemSize)
LIBGDIPLUS_TEST (testgpimage, test_getPropertyItem)
LIBGDIPLUS_TEST (testgpimage, test_getPropertySize)
LIBGDIPLUS_TEST (testgpimage, test_getAllPropertyItems)
LIBGDIPLUS_TEST (testgpimage, test_removePropertyItem)
LIBGDIPLUS_TEST (testgpimage, test_setPropertyItem)
