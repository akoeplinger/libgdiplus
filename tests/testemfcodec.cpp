...
{ \
	...
	fclose (f); \
 \
	status = GdipLoadImageFromFile (wFile, &testemfcodec_image); \
...
{ \
	...
	verifyMetafile (testemfcodec_image, emfRawFormat, x, y, width, height, dimensionWidth, dimensionHeight) \
	GdipDisposeImage (testemfcodec_image); \
}
...
LIBGDIPLUS_TEST (testemfcodec, test_valid)
LIBGDIPLUS_TEST (testemfcodec, test_invalidHeader)
LIBGDIPLUS_TEST (testemfcodec, test_invalidData)
