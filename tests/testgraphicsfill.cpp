...
LIBGDIPLUS_TEST (testgraphicsfill, test_fillClosedCurve)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillClosedCurveI)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillClosedCurve2)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillClosedCurve2I)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillEllipse)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillEllipseI)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillPath)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillPie)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillPieI)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillPolygon)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillPolygonI)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillPolygon2)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillPolygon2I)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillRectangle)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillRectangleI)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillRectangles)
LIBGDIPLUS_TEST (testgraphicsfill, test_fillRectanglesI)
