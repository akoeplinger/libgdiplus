...
static void test_createTexture ()
{
    ...
    assertEqual (brush, (GpTexture *) 0xCC);
...
static void test_getTextureImage ()
{
    ...
    assertEqualInt (status, Ok);
    assertTrue(brushImage1 != image) << "The texture image should be a clone.";

    status = GdipGetTextureImage (brush, &brushImage2);
    assertEqualInt (status, Ok);
    assertTrue (brushImage2 != brushImage1) << "The texture image should be a clone.";
...
LIBGDIPLUS_TEST (testtexturebrush, test_clone)
LIBGDIPLUS_TEST (testtexturebrush, test_delete)
LIBGDIPLUS_TEST (testtexturebrush, test_createTexture)
LIBGDIPLUS_TEST (testtexturebrush, test_createTexture2)
LIBGDIPLUS_TEST (testtexturebrush, test_createTexture2I)
LIBGDIPLUS_TEST (testtexturebrush, test_createTextureIA)
LIBGDIPLUS_TEST (testtexturebrush, test_createTextureIAI)
LIBGDIPLUS_TEST (testtexturebrush, test_getTextureImage)
LIBGDIPLUS_TEST (testtexturebrush, test_getTextureWrapMode)
LIBGDIPLUS_TEST (testtexturebrush, test_setTextureWrapMode)
LIBGDIPLUS_TEST (testtexturebrush, test_getTextureTransform)
LIBGDIPLUS_TEST (testtexturebrush, test_setTextureTransform)
LIBGDIPLUS_TEST (testtexturebrush, test_resetTextureTransform)
LIBGDIPLUS_TEST (testtexturebrush, test_multiplyTextureTransform)
LIBGDIPLUS_TEST (testtexturebrush, test_translateTextureTransform)
LIBGDIPLUS_TEST (testtexturebrush, test_scaleTextureTransform)
LIBGDIPLUS_TEST (testtexturebrush, test_rotateTextureTransform)
