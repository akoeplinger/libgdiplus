...
if ! test -e external/googletest/README.md; then
	echo "Error: Couldn't find the required submodules. This usually happens when using an archive from GitHub instead of https://download.mono-project.com/sources/libgdiplus/, or something went wrong while updating submodules."
	exit 1
fi
